...
public class EchoServer extends Actor {
    ...
    public EchoServer(ActorGroup actorGroup, SocketAddress socketAddress) throws IOException {
        super(actorGroup);
        inp.connect(socketAddress, 2);
    }
    ...
    protected void runAction() throws Throwable {
        ...
        EchoProcessor processor =
                new EchoProcessor(getActorGroup(), serverConn, connBSerialNum++); // create client connection
        processor.start();
    }
