 ...
 */
public class FuturePort<R> extends CountDownLatch implements Future<R>, Port<R> {
     ...
     */
    @Override
    public FuturePort<R> send(R result) {
        if (result==null) {
            throw new NullPointerException();
        }
        if (this.result!=null) {
            throw new IllegalStateException("done already");
        }
        this.result=result;
        super.countDown();
        return this;
