 ...
 *   Implementations which allow single tokens and that which allow streams of tokens, use the same interfaces.
 *
 ...
 *    We can avoid creating new node classes, if our computation procedures are of standard java functional types like `Function`, `BiFunction` etc:
 *
 <pre>
 @Test
