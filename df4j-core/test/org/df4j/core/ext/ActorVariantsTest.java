...
public class ActorVariantsTest {
     ...
     */
    static class Aggregator extends Actor1<DoubleValue> {

        // outputs
        Demand<Double> sum=new Demand<Double>(this);
        Demand<Double> avg=new Demand<Double>(this);
    ...
    public void testA(Aggregator node) throws InterruptedException, ExecutionException, TimeoutException {
        Promise<Double> sumcf=new Promise<Double>();
        Promise<Double> avgcf=new Promise<Double>();
