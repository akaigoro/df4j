...
public interface SingleObserver<T> {
     ...
     * connection (channel) with the SingleSource in both
    ...
    /**
     * Notifies the SingleObserver with a single item and that the {@link SingleSource} has finished sending
     * push-based notifications.
     * <p>
     * The {@link SingleSource} will not call this method if it calls {@link #onError}.
     *
     * @param t
     *          the item emitted by the SingleSource
     */
    void onSuccess(@NonNull T t);

    /**
     * Notifies the SingleObserver that the {@link SingleSource} has experienced an error condition.
     * <p>
     * If the {@link SingleSource} calls this method, it will not thereafter call {@link #onSuccess}.
     *
     * @param e
     *          the exception encountered by the SingleSource
     */
