...
import org.df4j.test.util.StringMessage;
...
public class SwingActorTest extends JFrame {
    ...
    class ComputingActor extends Actor1<StringMessage> implements ActionListener{
     ...
     */
    class PrintingActor extends Actor1<StringMessage> {
